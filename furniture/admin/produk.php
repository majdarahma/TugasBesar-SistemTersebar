...
<body id="page-top">
  ...
  <?php $ambil = $koneksi->query("SELECT * FROM tbl_produk"); ?>
    ...
    <tr>
      ...
      <td>
      <a href="ubah.php?id=<?= $perproduk['id_produk'];?>" class="btn btn-success" role="button" aria-pressed="true">Edit</a>
      <a href="hapus.php?id=<?= $perproduk['id_produk'];?>" class="btn btn-danger">Delete</a>
      </td>
    </tr>
  </tbody>
  <?php $i++; ?>
